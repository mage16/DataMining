...
public class AlgoCFPGrowth_saveToFile {
	 ...
	 */
		...
		// Before inserting a transaction in the MISTree, we sort the items
...
*/
	 ...
	 */
	private void fpgrowth(MISTree tree, String[] prefixAlpha, int prefixSupport, Map<String, Integer> mapSupport) throws IOException {
	 ...
	 * @throws IOException  exception if error writing the output file
	 */
	private void fpgrowthMoreThanOnePath(MISTree tree, String [] prefixAlpha, int prefixSupport, Map<String, Integer> mapSupport) throws IOException {
	 ...
	 */
	private void addAllCombinationsForPathAndPrefix(MISNode node, String[] prefix) throws IOException {
...
//			addAllCombinationsForPathAndPrefix(node.nodeLink, prefix);
	...
	{
		PrintWriter writer = new PrintWriter("ClosetFPGrowthStats", "UTF-8");
		writer.println("=============  Closet FP-GROWTH - STATS =============");
	...
	public void printStats() throws FileNotFoundException, UnsupportedEncodingException {
		System.out
				.println("=============  Closet FP-GROWTH - STATS =============");
		long temps = endTime - startTimestamp;
	...
	public ArrayList<String> getStats() {
		...
		stats.add("=============  Closet FP-GROWTH - STATS =============");
		long temps = endTime - startTimestamp;
